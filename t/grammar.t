...
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].level   == 1         , "level 1";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].header  eq "header"  , "header 1";
...
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].level             == 1           , "level 1";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].header            eq "header"    , "header 1";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].tasks[0].level    == 2           , "level 2";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].tasks[0].header   eq "sub-header", "sub-header";
...
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].level    == 1           , "level 1";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].header   eq "header"    , "header 1";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[1].level    == 1           , "level 1";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[1].header   eq "header 2"  , "header 2";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[2].level    == 1           , "level 1";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[2].header   eq "header 3"  , "header 3";
...
ok OrgMode.parse($file), 'parses';
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].todo     eq "TODO"    , "TODO";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].priority eq "B"       , "B";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].level    == 1         , "level 1";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].header   eq "header"  , "header";
...
ok OrgMode.parse($file), 'parses';
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].header   eq "Space before tag"  , "Space before tag";
ok OrgMode.parse($file,:actions(OrgMode::Actions)).made.tasks[0].tags[0]  eq "tag1"    , "tag1";

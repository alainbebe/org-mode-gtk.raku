...
*** TODO Orgzly mode vs emacs mode :0.1:
...
<, ^, v,..
** TODO Add Cancel when warning for save file :0.1:
...
** TODO Refactoring new file with GtkFile = .new :0.1:
** DONE [#A] Fold All
...
** TODO [#A] Warning if Save as on an existent file :0.1:
